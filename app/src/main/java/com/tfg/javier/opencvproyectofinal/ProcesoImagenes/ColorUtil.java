...
public class ColorUtil {
    ...
    public static double getColorDifference(Scalar a, Scalar b) {
        ...
        double [] arrayA = a.val;
        double [] arrayB = b.val;
        int[] lab1 = rgb2lab((int) arrayA[0],(int) arrayA[1],(int) arrayA[2]);
        int[] lab2 = rgb2lab((int) arrayB[0],(int) arrayB[1],(int) arrayB[2]);
        return Math.sqrt(Math.pow(lab2[0] - lab1[0], 2) + Math.pow(lab2[1] - lab1[1], 2) + Math.pow(lab2[2] - lab1[2], 2));
    }

    public static double getColorDifference(Scalar a, int b) {
        int r1, g1, b1, r2, g2, b2;
        double [] arrayA = a.val;
        r1 = (int)arrayA[0];
        g1 = (int)arrayA[1];
